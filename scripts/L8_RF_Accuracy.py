...
# Training and Testing Data from Landsat-8 data
...
results_txt = path_to_restults + 'L8_Accuracy.txt'
...
def Model_Diagnostics(RF_Value, X_Value, y_Value):
    ...
    band_names = ['BR_NDWI', 'GNIR_NDWI', 'NWI', 'NDSI_MNDWI', 'SWI', 
                  ...
                  'TC_wet', 'TIRS_Blue', 'Aerosol', 'Blue', 'Green', 'Red', 
                  'NIR', 'SWIR1', 'SWIR2', 'Panchromatic',
                  'SWIRCirrus', 'LWIR1_Resampled', 'LWIR2_Resampled']
